...
namespace GameFrameX.Login.Google.Runtime
{
    ...
    public sealed class GoogleLoginManager : GameFrameworkModule, IGoogleLoginManager
    {
        [UnityEngine.Scripting.Preserve]
        ...
        {
            GoogleLoginLinkBridge.Instance.Init(projectId);
        }
        ...
        public void LogOut()
        {
            GoogleLoginLinkBridge.Instance.SignOut();
        }
